...
from src.indTest.HSICSpectralTestObject import HSICSpectralTestObject
from src.indTest.HSICBlockTestObject import HSICBlockTestObject
import numpy as np
import pandas as pd
...
##    kernelX=GaussianKernel(float(0.3))
    ...
    pvalue = myspectralobject.compute_pvalue(data_x = x, data_y = y)
